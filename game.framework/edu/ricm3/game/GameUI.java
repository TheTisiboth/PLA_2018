...
public class GameUI {
	...
	private void createWindow(Dimension d) {
		...
		panNorthLabel.add(l1);
		panNorthLabel.add(l2);
		panNorthLabel.add(l3);
		panNorthLabel.add(l4);
		panNorthLabel.add(l5);
		panNorthLabel.add(l6);
		panNorthLabel.add(l7);
		panNorthLabel.add(l8);
		panNorthLabel.add(l9);
		...
		panNorthBar.add(barJ1);
		panNorthBar.add(barJ2);
